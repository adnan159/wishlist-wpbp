		...
		<>
			<Page classes="">
				<div className=" wm-col-span-12 ">
					<div className=" wm-pb-8 ">
						<h2 className="wm-text-base wm-font-semibold ctx-gray-800">
							Preview
						</h2>
					</div>

					<div className="wm-py-8 wm-px-8 wm-border wm-border-gray-200  wm-rounded-lg wm-mx-auto">
						<div className=" wm-mx-auto wm-bg-white wm-border-4 wm-text-center wm-py-6">
							<div className="wm-border wm-border-gray-300 wm-w-36 wm-py-2 wm-mb-3 wm-px-4 wm-block wm-mx-auto">
								{ buttonStyle.popup_icon_image === '' ? (
									<img
										className="wm-mx-auto"
							...
							<span className=" wm-text-base">
								Chose a wishlist
							</span>
							<div className="wm-my-4 wm-px-6 ">
								<Select
									classes=""
									size="wm-h-12 wm-w-full wm-my-6"
								/>
								<Button
									onClick={ () => {
										window.open();
									...
									iconPosition={ 'after' }
									addBgColor={ true }
									classNames={ 'wm-w-full wm-bg-default' }
									icon={ '' }
