...
class PostTypes extends Base {
	...
	public function initialize() { // phpcs:ignore
		...
		$post_columns->add_column(
			'cmb2_field',
			array(
				'label'    => \__( 'CMB2 Field', WW_TEXTDOMAIN ),
				'type'     => 'post_meta',
				'meta_key' => '_demo_' . WW_TEXTDOMAIN . '_text', // phpcs:ignore WordPress.DB
				'orderby'  => 'meta_value',
				'sortable' => true,
				'prefix'   => '<b>',
				'suffix'   => '</b>',
			...
			array(
				...
				'callback'     => static function( $post_ids ) {
					foreach ( $post_ids as $post_id ) {
						\update_post_meta( $post_id, '_demo_' . WW_TEXTDOMAIN . '_text', 'Random stuff' );
					}
	...
	public function load_cpts() { //phpcs:ignore
		...
		$demo_cpt = \register_extended_post_type(
				...
				array(
					...
					'admin_cols'         => array(
						...
						'custom_field'   => array(
							'title'    => 'By Lib',
							'meta_key' => '_demo_' . WW_TEXTDOMAIN . '_text', // phpcs:ignore
							'cap'      => 'manage_options',
						),
						'date'           => array(
							'title'   => 'Date',
			...
			array(
				...
				'singular' => \__( 'Demo', WW_TEXTDOMAIN ),
				'plural'   => \__( 'Demos', WW_TEXTDOMAIN ),
			)
		);
		...
		\register_extended_taxonomy(
			...
			array(
				// Override the base names used for labels:
				'singular' => \__( 'Demo Category', WW_TEXTDOMAIN ),
				'plural'   => \__( 'Demo Categories', WW_TEXTDOMAIN ),
			)
		);
	}
