...
class MyWishlistPageSettings {
    public function get_my_wishlist_settings() {
        $my_wishlist_page_settings = maybe_unserialize( get_option( 'ww_my_wishlist_settings' ) );
    ...
    public function edit_my_wishlist_settings( $prepared ) {
        ...
        update_option( 'ww_my_wishlist_settings', maybe_serialize( $updated ) );

        $updated = maybe_unserialize( get_option('ww_my_wishlist_settings') );
