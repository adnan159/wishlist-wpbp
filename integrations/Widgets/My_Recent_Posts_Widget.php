...
namespace WooCommerce_Wishlist\Integrations\Widgets;
...
class My_Recent_Posts_Widget extends \WPH_Widget {
	...
	public function __construct() { // phpcs:ignore
		$args = array(
			'label'       => \__( 'My Recent Posts Example', WW_TEXTDOMAIN ),
			'description' => \__( 'My Recent Posts Widget Description', WW_TEXTDOMAIN ),
			'slug'        => 'recent-posts',
		...
		$args[ 'fields' ] = array(
			...
			array(
				// Field name/label
				'name'     => \__( 'Title', WW_TEXTDOMAIN ),
				// Field description
				'desc'     => \__( 'Enter the widget title.', WW_TEXTDOMAIN ),
				// Field id
				'id'       => 'title',
				...
				'class'    => 'widefat',
				// Default value
				'std'      => \__( 'Recent Posts', WW_TEXTDOMAIN ),
				/**
			...
			// Taxonomy Field
			array(
				'name'  => \__( 'Taxonomy', WW_TEXTDOMAIN ),
				'desc'  => \__( 'Set the taxonomy.', WW_TEXTDOMAIN ),
				'id'    => 'taxonomy',
				'type'  => 'taxonomy',
				'class' => 'widefat',
			),
			// Taxonomy Field
			array(
				'name'     => \__( 'Taxonomy terms', WW_TEXTDOMAIN ),
				'desc'     => \__( 'Set the taxonomy terms.', WW_TEXTDOMAIN ),
				'id'       => 'taxonomyterm',
				'type'     => 'taxonomyterm',
				'taxonomy' => 'category',
				'class'    => 'widefat',
			...
			// Pages Field
			array(
				'name'  => \__( 'Pages', WW_TEXTDOMAIN ),
				'desc'  => \__( 'Set the page.', WW_TEXTDOMAIN ),
				'id'    => 'pages',
				'type'  => 'pages',
				'class' => 'widefat',
			),
			// Post type Field
			array(
				'name'     => \__( 'Post type', WW_TEXTDOMAIN ),
				'desc'     => \__( 'Set the post type.', WW_TEXTDOMAIN ),
				'id'       => 'posttype',
				'type'     => 'posttype',
				'posttype' => 'post',
				'class'    => 'widefat',
			...
			// Amount Field
			array(
				'name'     => \__( 'Amount', WW_TEXTDOMAIN ),
				'desc'     => \__( 'Select how many posts to show.', WW_TEXTDOMAIN ),
				'id'       => 'amount',
				'type'     => 'select',
				// Selectbox fields
				'fields'   => array(
					array(
						'name'  => \__( '1 Post', WW_TEXTDOMAIN ),
						'value' => '1',
					),
					array(
						'name'  => \__( '2 Posts', WW_TEXTDOMAIN ),
						'value' => '2',
					),
					array(
						'name'  => \__( '3 Posts', WW_TEXTDOMAIN ),
						'value' => '3',
					),
			...
			array(
				'name'   => \__( 'Output as list', WW_TEXTDOMAIN ),
				'desc'   => \__( 'Wraps posts with the <li> tag.', WW_TEXTDOMAIN ),
				'id'     => 'list',
				'type'   => 'checkbox',
				// Checked by default:
				'std'    => 1, // 0 or 1
	...
	public function initialize() {
		...
		'widgets_init',
		static function() {
			\register_widget( 'WooCommerce_Wishlist\Integrations\Widgets\My_Recent_Posts_Widget' );
		}
		);
	}
